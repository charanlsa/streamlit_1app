...
def main():
    ...
    input_source = st.sidebar.selectbox("Source",
                                         ('Image','Video', 'WebCam'))
    ...
    save_output_video = st.sidebar.selectbox("Save output video?",
                                         ('Yes', 'No'))
 ...
 # ------------------------- LOCAL IMAGE ------------------------
    if input_source == "Image":
        ...
        if st.sidebar.button("Start Detection"):
            ...
            st.markdown("""<h4 style="color:white;">
            ...
            inference_msg.success("Succesfully Detected !")
    ...
    if input_source == "Video":
        ...
        if st.sidebar.button("Start Tracking"):
            ...
            inference_msg.success("Succesfully Tracking!")
